  ...
  return pn || (pn = 1, (function(Vt, qt) {
    (function(l, it) {
      ...
      function Ne(t, e, i, n, o) {
        ...
        if (!s)
          return this;
        !f.touchNative && f.pointer && e.indexOf("touch") === 0 ? Hn(t, e, s) : f.touch && e === "dblclick" ? Yn(t, s) : "removeEventListener" in t ? t.removeEventListener(Ae[e] || e, s, !1) : t.detachEvent("on" + e, s), t[Q][o] = null;
      }
      function pt(t) {
      ...
      w.addInitHook("addHandler", "touchZoom", fn), w.BoxZoom = rn, w.DoubleClickZoom = an, w.Drag = hn, w.Keyboard = un, w.ScrollWheelZoom = ln, w.TapHold = cn, w.TouchZoom = fn, l.Bounds = z, l.Browser = f, l.CRS = ot, l.Canvas = en, l.Circle = qe, l.CircleMarker = ne, l.Class = nt, l.Control = Y, l.DivIcon = $i, l.DivOverlay = et, l.DomEvent = Qn, l.DomUtil = Jn, l.Draggable = ct, l.Evented = zt, l.FeatureGroup = st, l.GeoJSON = at, l.GridLayer = Ht, l.Handler = tt, l.Icon = Lt, l.ImageOverlay = he, l.LatLng = b, l.LatLngBounds = H, l.Layer = X, l.LayerGroup = Pt, l.LineUtil = fo, l.Map = w, l.Marker = ie, l.Mixin = ro, l.Path = ft, l.Point = m, l.PolyUtil = ao, l.Polygon = Tt, l.Polyline = rt, l.Popup = ue, l.PosAnimation = Ii, l.Projection = _o, l.Rectangle = sn, l.Renderer = ht, l.SVG = Ut, l.SVGOverlay = Ji, l.TileLayer = Mt, l.Tooltip = le, l.Transformation = ge, l.Util = yn, l.VideoOverlay = Xi, l.bind = S, l.bounds = F, l.canvas = nn, l.circle = Po, l.circleMarker = xo, l.control = Rt, l.divIcon = Eo, l.extend = x, l.featureGroup = go, l.geoJSON = Yi, l.geoJson = bo, l.gridLayer = Zo, l.icon = yo, l.imageOverlay = Mo, l.latLng = y, l.latLngBounds = O, l.layerGroup = vo, l.map = to, l.marker = wo, l.point = _, l.polygon = To, l.polyline = Lo, l.popup = zo, l.rectangle = Ao, l.setOptions = C, l.stamp = P, l.svg = on, l.svgOverlay = Co, l.tileLayer = Qi, l.tooltip = ko, l.transformation = kt, l.version = it, l.videoOverlay = So;
      var No = window.L;
...
var vn = Yo();
const Xo = /* @__PURE__ */ qo(vn), $o = /* @__PURE__ */ jo({
  __proto__: null,
  default: Xo
}, [vn]);
export {
...
//# sourceMappingURL=leaflet-src-D753uetq.js.map
