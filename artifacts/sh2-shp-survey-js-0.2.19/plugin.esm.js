...
import { useMemo as te, useState as j, useRef as oe, useEffect as R, useCallback as L, forwardRef as ss, createElement as He } from "/api/plugins/runtime-shim/react";
import { useMantineTheme as os, useComputedColorScheme as as, Alert as B, Stack as I, Loader as de, Text as x, Group as M, Button as J, Box as ar, Paper as me, Title as Z, TextInput as Pe, Tooltip as W, ActionIcon as ae, Badge as N, Card as ce, Menu as P, Table as m, Modal as Te, Code as re, SimpleGrid as ts, Tabs as H, Select as $r, Checkbox as ns, ScrollArea as is, Anchor as ls } from "/api/plugins/runtime-shim/@mantine/core";
...
`).split(/\n{2,}/).map((o) => {
    const a = o.trim();
    return a === "" ? "" : /^(- |\* )/.test(a) ? `<ul>${a.split(/\n/).filter((i) => /^(- |\* )/.test(i)).map((i) => `<li>${dr(i.replace(/^(- |\* )/, ""))}</li>`).join("")}</ul>` : `<p>${dr(a).replace(/\n/g, "<br>")}</p>`;
  }).join("") : "";
}
function zs({
...
function Ms(e, r, o) {
  ...
  const b = (e.locale || "en").slice(0, 2), f = c !== "" ? c : ur[b] ?? ur.en ?? "", k = () => {
    !d || y || typeof window < "u" && f && alert(f);
  };
  ...
  function C() {
    const E = {
      ...
      autoStart: n,
      watched: g,
      completedAt: y ? (/* @__PURE__ */ new Date()).toISOString() : null
    }, v = e;
...
async function Fs(e, r, o) {
  ...
  const y = Math.max(5, Number(r.getPropertyValue("maxDurationSeconds") ?? 60));
  n.addEventListener("click", async () => {
    ...
    }), d.start(), p = Date.now(), n.disabled = !0, c.disabled = !1, t.textContent = "Recording…", y > 0 && window.setTimeout(() => {
...
async function Nr(e) {
  ...
  e.flags.richText && zs({ componentCollection: o, richTextEditor: e.richTextEditor }), e.flags.video && Es({ componentCollection: o, serializer: a }), e.flags.gpx && Is({ componentCollection: o, serializer: a }), e.flags.microphone && _s({ componentCollection: o, serializer: a }), br = !0;
}
function Os(e, r) {
...
function Or(e, r) {
  return e === "default" && r ? r : Js[e] ?? r ?? Lr;
}
function Br(e, r = null) {
  const o = Or(e, r);
  return {
    cssVariables: {
...
function qs({
  ...
  const t = r ?? e, i = te(() => le(t, "survey-js"), [t]), n = te(() => le(t, "survey-js-theme"), [t]), c = te(() => oo(t), [t]), d = Fr(), [l, g] = j(null), [p, y] = j(null), [b, f] = j({ kind: "loading" }), [k, C] = j(null), E = oe(null), v = oe(null), D = oe(null), S = oe(null), O = oe(!1), V = oe(null);
  R(() => {
    let _ = !1;
    return (async () => {
      try {
    ...
    return us(i, Zs(c), h).then((z) => {
      if (_) return;
      y(z), E.current = new ws(`sh2-shp-survey-js:${z.surveyId}`);
      const F = vr("record_id") ?? vr("responseId");
    ...
    return F > 0 && (G = setInterval(() => {
      ...
      ps(p.surveyId, A.data, ee).then((X) => {
        ...
        const ne = X.reason ?? "";
        if (ne === "already_submitted_once" || ne === "already_submitted_in_window") {
          f({
            kind: "locked",
            label: p.runtimeConfig.labelSurveyDone,
            reason: ne
  ...
  const T = L(() => {
    !p || !k || (E.current && D.current && E.current.clear(D.current), D.current = null, v.current = Ar(), k.clear(!0, !0));
  }, [p, k]);
  if (!i)
...
async function Ws(e, r) {
  ...
  if (c(Ar()), i) {
    const l = await ys(o.surveyId, i).catch(() => null);
    if (l) {
...
function Ys(e, r, o) {
  const a = e.oncePerSchedule ? Vr(e.startTime, e.endTime) : null;
  return {
...
function Xs(e) {
  ...
  const r = /* @__PURE__ */ new Date(), o = hr(e.startTime), a = hr(e.endTime);
...
function Zs(e) {
  const r = e.oncePerSchedule ? Vr(e.startTime, e.endTime) : null;
  return {
...
function oo(e) {
  return {
    ...
    autoSaveIntervalSeconds: xr(e, "auto_save_interval", 0),
    timeoutMinutes: xr(e, "timeout", 0),
    savePdf: be(e, "save_pdf", !1),
    closeModalAtEnd: be(e, "close_modal_at_end", !1),
    redirectAtEnd: le(e, "redirect_at_end"),
    urlParams: be(e, "url_params", !1),
    startTime: le(e, "start_time"),
    endTime: le(e, "end_time"),
    ...
    labelSurveyDone: le(e, "label_survey_done"),
    labelSurveyNotActive: le(e, "label_survey_not_active"),
    dataConfig: wr(e, "data_config"),
    dynamicReplacement: wr(e, "dynamic_replacement")
  };
}
function le(e, r) {
...
function to({ style: e, section: r, styleProps: o, cssClass: a }) {
  ...
  return R(() => {
    ...
    return (async () => {
      ...
      const p = g.default ?? g, y = p.map(n.current).setView([46.95, 7.45], 13);
      c = y, p.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", {
        maxZoom: 19,
      ...
      try {
        ...
        if (f.length > 0) {
          const k = p.polyline(f, { color: "#228be6" }).addTo(y);
          y.fitBounds(k.getBounds());
        }
      } catch (b) {
...
const U = (e, r, o, a) => {
  const t = ss(
    ({ color: i = "currentColor", size: n = 24, stroke: c = 2, title: d, className: l, children: g, ...p }, y) => He(
      "svg",
      {
        ref: y,
        ...lo[e],
...
const co = [["path", { d: "M3 6a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2", key: "svg-0" }], ["path", { d: "M5 8v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-10", key: "svg-1" }], ["path", { d: "M10 12l4 0", key: "svg-2" }]], Sr = U("outline", "archive", "Archive", co);
...
const po = [["path", { d: "M5 12l5 5l10 -10", key: "svg-0" }]], Jr = U("outline", "check", "Check", po);
const go = [["path", { d: "M15 6l-6 6l6 6", key: "svg-0" }]], bo = U("outline", "chevron-left", "ChevronLeft", go);
const fo = [["path", { d: "M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2", key: "svg-0" }], ["path", { d: "M9 5a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2", key: "svg-1" }], ["path", { d: "M9 12l.01 0", key: "svg-2" }], ["path", { d: "M13 12l2 0", key: "svg-3" }], ["path", { d: "M9 16l.01 0", key: "svg-4" }], ["path", { d: "M13 16l2 0", key: "svg-5" }]], yo = U("outline", "clipboard-list", "ClipboardList", fo);
const mo = [["path", { d: "M7 9.667a2.667 2.667 0 0 1 2.667 -2.667h8.666a2.667 2.667 0 0 1 2.667 2.667v8.666a2.667 2.667 0 0 1 -2.667 2.667h-8.666a2.667 2.667 0 0 1 -2.667 -2.667l0 -8.666", key: "svg-0" }], ["path", { d: "M4.012 16.737a2.005 2.005 0 0 1 -1.012 -1.737v-10c0 -1.1 .9 -2 2 -2h10c.75 0 1.158 .385 1.5 1", key: "svg-1" }]], kr = U("outline", "copy", "Copy", mo);
...
const Oo = [["path", { d: "M18 6l-12 12", key: "svg-0" }], ["path", { d: "M6 6l12 12", key: "svg-1" }]], Hr = U("outline", "x", "X", Oo), K = "/api/admin/plugins/sh2-shp-survey-js";
function ye() {
  if (typeof document > "u")
    return {};
  const e = document.cookie.split("; ").find((r) => r.startsWith("sh_csrf="))?.slice(8);
...
async function Vo(e) {
  const r = await fetch(`${K}/surveys/${e}`, {
    method: "DELETE",
    credentials: "include",
    headers: { Accept: "application/json", ...ye() }
  });
  return Q(r);
}
async function Jo(e) {
  const r = `${e.name} (copy)`, o = e.definition ?? { pages: [] }, a = await qr({ name: r, definition: o });
  return Object.keys(o).length > 0 && await Gr(a.id, { definition: o, force: !0 }), a;
}
...
const Qo = (() => {
  try {
    return typeof window > "u" || typeof window.location > "u" ? !1 : new URL(import.meta.url).origin !== window.location.origin;
  } catch {
    return !1;
  }
})(), zr = "__sh2_shp_survey_js_tiptap_registered__", Yo = [
      ...
      const i = {
        ...
        onCreated: (n, c, d) => {
          queueMicrotask(() => {
            ...
            y.style.minHeight = "120px", p.style.display = "none", p.parentElement?.insertBefore(y, p);
            const b = {
              format: t.format,
              ...
              document.body.contains(y) || (f.destroy(), k.disconnect());
            });
...
function Le(e, r) {
  ...
  i.forEach((y, b) => {
    c.set(Pr(y, b), { page: y, index: b });
  });
  const d = /* @__PURE__ */ new Map();
  n.forEach((y, b) => {
    d.set(Pr(y, b), { page: y, index: b });
  });
  for (const [y, { page: b, index: f }] of c.entries())
    d.has(y) || t.push({
      kind: "removed",
      path: `pages[${f}]`,
      label: qe(b, f),
  ...
  for (const [y, { page: b, index: f }] of d.entries()) {
    const k = c.get(y);
    if (!k) {
      t.push({
        kind: "added",
  ...
  const l = /* @__PURE__ */ new Set(["pages"]), g = /* @__PURE__ */ new Set([
    ...Object.keys(o).filter((y) => !l.has(y)),
    ...Object.keys(a).filter((y) => !l.has(y))
  ]);
  for (const y of g) {
    const b = o[y], f = a[y];
    Ee(b) !== Ee(f) && t.push({
...
function ea(e, r, o, a) {
  ...
  t.forEach((d, l) => n.set(Er(d, l), { question: d, index: l }));
  const c = /* @__PURE__ */ new Map();
  i.forEach((d, l) => c.set(Er(d, l), { question: d, index: l }));
...
function oa({ surveyId: e, onSurveyChanged: r } = {}) {
  const [o, a] = j(null), [t, i] = j(null), [n, c] = j(null), [d, l] = j(null), [g, p] = j(null), [y, b] = j(null), [f, k] = j(!1), [C, E] = j(!1), [v, D] = j({}), [S, O] = j(!1), [V, T] = j(0), [q, _] = j(!1), [h, z] = j(""), [F, G] = j(!1), Y = oe(null), je = Fr(), A = t?.themeCode ?? "default", ee = sr({
  ...
  R(() => {
    ...
    !w || w.type !== "presence" || !w.userId || !w.userName || !w.at || D(($) => {
      const ie = { ...$ };
      return w.state === "left" ? (delete ie[w.userId], ie) : (ie[w.userId] = {
        name: w.userName,
        at: w.at,
  ...
  const X = te(
    ...
    const w = ue(), $ = t.publishedDefinition ?? null, ie = Le($, w);
    O(ie.hasChanges), T(ie.totalChanges);
  }, [ue, t]), Ie = L((w) => {
    const $ = w;
    $.applyTheme?.(Br(A, je)), $.applyCreatorTheme?.(Hs(A, je));
  }, [je, A]);
  R(() => {
  ...
  if (R(() => {
    ...
    let w = !1;
    return (async () => {
      const ie = await tr().catch(() => ({ licenseKey: null, configured: !1 }));
      if (w) return;
      if (b(!!ie.configured), ie.licenseKey) {
        const se = await import("./survey-core-BYbqeafP.js");
        typeof se.setLicenseKey == "function" && se.setLicenseKey(ie.licenseKey);
      }
      const Zr = {
        showLogicTab: !0,
        isAutoSave: !1,
        showThemeTab: !0,
        showJSONEditorTab: !0
      }, pe = new o.SurveyCreator(Zr);
      Ie(pe), t?.definition && (pe.JSON = t.definition);
      try {
        const se = o.rawModule.Serializer ?? (await import("./survey-core-BYbqeafP.js")).Serializer;
        se && typeof se.addProperty == "function" && !se.getProperty?.("survey", "richTextEditor") && se.addProperty("survey", {
      ...
      const he = _r();
      he && Xo(t?.definition ?? {}) && Zo(o.rawModule, he);
      const $e = (se, ge) => {
        if (!he || typeof he.isFeatureEnabled != "function") return ge;
        try {
          return he.isFeatureEnabled(se);
        } catch {
          return ge;
        }
      };
      ...
      Ve && typeof Ve.add == "function" && Ve.add(() => {
        const se = pe.JSON, ge = t?.publishedDefinition ?? null, ve = Le(ge, se);
        O(ve.hasChanges), T(ve.totalChanges);
      }), c(pe);
      const Je = pe.JSON, cr = Le(
        t?.publishedDefinition ?? null,
        Je && Object.keys(Je).length > 0 ? Je : { pages: [] }
      );
      O(cr.hasChanges), T(cr.totalChanges);
    })(), () => {
      w = !0;
    };
  }, [Ie, o, ne, t, e]), R(() => {
  ...
  const Xr = o.SurveyCreatorComponent;
  return /* @__PURE__ */ u(I, { gap: "sm", children: [
          ...
          /* @__PURE__ */ u(I, { gap: 2, style: { flex: 1, minWidth: 0 }, children: [
            /* @__PURE__ */ u(M, { gap: "xs", wrap: "nowrap", children: [
              q ? /* @__PURE__ */ u(M, { gap: "xs", wrap: "nowrap", style: { flex: 1 }, children: [
                ...
                /* @__PURE__ */ s(W, { label: "Rename (double-click title)", children: /* @__PURE__ */ s(ae, { size: "sm", variant: "subtle", onClick: ir, "aria-label": "Rename survey", children: /* @__PURE__ */ s(_e, { size: 14 }) }) })
              ] }),
    ...
    y === !1 && /* @__PURE__ */ u(B, { color: "yellow", title: "SurveyJS license key not configured", children: [
    ...
    /* @__PURE__ */ s(me, { withBorder: !0, p: 0, className: "surveyjs-creator-shell", children: /* @__PURE__ */ s(Xr, { creator: n }) })
  ] });
}
function aa({ surveyId: e } = {}) {
  const [r, o] = j(null), [a, t] = j(0), [i, n] = j(null), [c, d] = j(!1), [l, g] = j(null), [p, y] = j(""), [b, f] = j(null), k = sr({
    pluginId: "sh2-shp-survey-js",
  ...
  return e ? i ? /* @__PURE__ */ s(B, { color: "red", title: "Could not load responses", children: i }) : r === null ? /* @__PURE__ */ u(M, { gap: "xs", justify: "center", py: "md", children: [
      ...
      /* @__PURE__ */ u(M, { gap: "xs", children: [
        /* @__PURE__ */ s(
          Pe,
          {
            ...
            value: p,
            onChange: (S) => y(S.currentTarget.value),
            size: "xs"
          }
        ),
    ...
    v.length === 0 ? /* @__PURE__ */ s(ce, { withBorder: !0, p: "lg", children: /* @__PURE__ */ u(I, { gap: "xs", align: "center", children: [
      /* @__PURE__ */ s(x, { c: "dimmed", children: "No responses recorded yet." }),
      /* @__PURE__ */ s(J, { variant: "subtle", onClick: () => {
        C();
      }, children: "Refresh" })
    ] }) }) : /* @__PURE__ */ s(me, { withBorder: !0, children: /* @__PURE__ */ u(m, { verticalSpacing: "sm", highlightOnHover: !0, children: [
      /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ u(m.Tr, { children: [
        /* @__PURE__ */ s(m.Th, { children: "Response ID" }),
        /* @__PURE__ */ s(m.Th, { children: "Status" }),
        /* @__PURE__ */ s(m.Th, { children: "Revision" }),
        /* @__PURE__ */ s(m.Th, { children: "User" }),
        /* @__PURE__ */ s(m.Th, { children: "Started" }),
        /* @__PURE__ */ s(m.Th, { children: "Completed" }),
        /* @__PURE__ */ s(m.Th, { style: { width: 60 } })
      ] }) }),
      /* @__PURE__ */ s(m.Tbody, { children: v.map((S) => /* @__PURE__ */ u(
        m.Tr,
        {
          onClick: () => {
          ...
          children: [
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", ff: "monospace", children: S.responseId }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(
              N,
              {
                variant: "light",
            ...
            /* @__PURE__ */ u(m.Td, { children: [
              "v",
              S.revision
            ] }),
            /* @__PURE__ */ s(m.Td, { children: S.userId ?? /* @__PURE__ */ s(x, { c: "dimmed", children: "anon" }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", children: new Date(S.startedAt).toLocaleString() }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", children: S.completedAt ? new Date(S.completedAt).toLocaleString() : "—" }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ u(M, { gap: 4, children: [
    ...
    l && /* @__PURE__ */ s(ce, { withBorder: !0, padding: "lg", children: /* @__PURE__ */ u(I, { gap: "sm", children: [
      /* @__PURE__ */ u(M, { justify: "space-between", children: [
      ...
      l.answers.length === 0 ? /* @__PURE__ */ s(x, { c: "dimmed", size: "sm", children: "No answer links were recorded for this run." }) : /* @__PURE__ */ u(m, { verticalSpacing: "xs", children: [
        /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ u(m.Tr, { children: [
          /* @__PURE__ */ s(m.Th, { children: "Question" }),
          /* @__PURE__ */ s(m.Th, { children: "Type" }),
          /* @__PURE__ */ s(m.Th, { children: "Value" })
        ] }) }),
        /* @__PURE__ */ s(m.Tbody, { children: l.answers.map((S) => /* @__PURE__ */ u(m.Tr, { children: [
          /* @__PURE__ */ s(m.Td, { children: S.questionName }),
          /* @__PURE__ */ s(m.Td, { children: S.questionType }),
          /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", lineClamp: 3, children: S.value || "—" }) })
        ] }, S.questionName)) })
      ] })
    ] }) })
  ] }) : /* @__PURE__ */ s(ce, { withBorder: !0, p: "lg", children: /* @__PURE__ */ u(I, { gap: "xs", align: "center", children: [
...
function na({ surveyId: e, results: r, onSelectResponse: o }) {
  const a = oe(null), [t, i] = j(null), [n, c] = j(!1), d = oe(null), l = `sh2-shp-survey-js:dashboard:${e}`, g = te(() => ia(r), [r]);
  return R(() => {
    let p = !1;
    return ta().then((y) => {
      if (!p) {
    ...
    const p = ua(l), y = la(g, p), b = (k) => {
      pa(l, k.map((C) => String(C.field ?? "")));
  ...
  }, [r]), n ? /* @__PURE__ */ s(ga, { results: r }) : t ? /* @__PURE__ */ s("div", { ref: a, style: { minHeight: 320 } }) : /* @__PURE__ */ s(x, { c: "dimmed", size: "sm", children: "Loading dashboard table…" });
}
function ia(e) {
  ...
  return [
    ...
    ...Array.from(r).sort().map((o) => ({
      title: ca(e.definition, o) ?? o,
      field: o,
      sorter: "string",
      headerFilter: "input",
      formatter: (a) => da(a.getValue())
    }))
  ];
}
function la(e, r) {
...
function ga({ results: e }) {
  ...
  return e.rows.length === 0 ? /* @__PURE__ */ s(B, { color: "gray", title: "No responses yet", children: "Once participants submit responses they will appear here." }) : /* @__PURE__ */ u(m, { verticalSpacing: "sm", striped: !0, highlightOnHover: !0, withTableBorder: !0, children: [
    /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ s(m.Tr, { children: r.map((o) => /* @__PURE__ */ s(m.Th, { children: Wr(o) }, o)) }) }),
    /* @__PURE__ */ s(m.Tbody, { children: e.rows.map((o, a) => /* @__PURE__ */ s(m.Tr, { children: r.map((t) => /* @__PURE__ */ s(m.Td, { children: String(o[t] ?? "") }, t)) }, String(o.response_id ?? a))) })
  ] });
}
async function ba() {
  try {
...
function fa({ results: e }) {
  const r = oe(null), [o, a] = j(null), [t, i] = j(!1), [n, c] = j(null);
  return R(() => {
    let d = !1;
    return Promise.all([
      ba(),
...
function ya({ surveyId: e } = {}) {
  ...
  R(() => {
    ...
    p.data?.type === "response_submitted" && y();
  }, [p.data, y]);
  const b = te(() => e ? {
    csv: we(e, "csv"),
    xlsx: we(e, "xlsx"),
  ...
  return e ? i ? /* @__PURE__ */ s(B, { color: "red", title: "Could not load dashboard", children: i }) : !r || !a ? /* @__PURE__ */ u(M, { gap: "xs", justify: "center", py: "md", children: [
    ...
    /* @__PURE__ */ u(H, { value: l, onChange: g, keepMounted: !1, children: [
      ...
      /* @__PURE__ */ s(H.Panel, { value: "table", pt: "md", children: /* @__PURE__ */ s(na, { surveyId: e, results: a }) }),
      /* @__PURE__ */ s(H.Panel, { value: "charts", pt: "md", children: /* @__PURE__ */ s(fa, { results: a }) })
    ] })
  ] }) : /* @__PURE__ */ s(ce, { withBorder: !0, p: "lg", children: /* @__PURE__ */ u(I, { gap: "xs", align: "center", children: [
...
function We({ label: e, value: r }) {
  return /* @__PURE__ */ s(ce, { withBorder: !0, padding: "lg", children: /* @__PURE__ */ u(I, { gap: 4, children: [
...
function ja({ surveyId: e, onRestored: r } = {}) {
  const [o, a] = j(null), [t, i] = j(null), [n, c] = j(!1), [d, l] = j(null), [g, p] = j({ baseId: null, targetId: null }), [y, b] = j(!1), [f, k] = j(!1), [C, E] = j(null), [v, D] = j(null), S = L(async () => {
    if (e) {
      i(null);
      try {
        const h = await Bo(e);
  ...
  return e ? /* @__PURE__ */ u(I, { gap: "md", children: [
    ...
    o === null ? /* @__PURE__ */ u(M, { justify: "center", py: "md", gap: "xs", children: [
    ...
    ] }) : o.length === 0 ? /* @__PURE__ */ s(B, { color: "gray", title: "No published versions yet", children: "Publish the survey from the Designer to create the first revision." }) : /* @__PURE__ */ u(ce, { withBorder: !0, p: 0, children: [
      ...
      /* @__PURE__ */ u(m, { verticalSpacing: "sm", striped: !0, highlightOnHover: !0, children: [
        /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ u(m.Tr, { children: [
          /* @__PURE__ */ s(m.Th, { style: { width: 60 }, children: "Compare" }),
          /* @__PURE__ */ s(m.Th, { children: "Revision" }),
          /* @__PURE__ */ s(m.Th, { children: "Published at" }),
          /* @__PURE__ */ s(m.Th, { children: "By" }),
          /* @__PURE__ */ s(m.Th, { children: "SHA-256" }),
          /* @__PURE__ */ s(m.Th, { style: { width: 110 } })
        ] }) }),
        /* @__PURE__ */ s(m.Tbody, { children: o.map((h, z) => {
          const F = g.baseId === h.id, G = g.targetId === h.id;
          return /* @__PURE__ */ u(m.Tr, { children: [
            /* @__PURE__ */ u(m.Td, { children: [
              /* @__PURE__ */ s(
                ns,
                {
            ...
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ u(M, { gap: "xs", children: [
              /* @__PURE__ */ u(N, { variant: "light", children: [
                "v",
                h.revision
              ] }),
            ...
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", children: new Date(h.createdAt).toLocaleString() }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", c: "dimmed", children: h.createdByUserId === null ? "system" : `user #${h.createdByUserId}` }) }),
            /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(W, { label: h.definitionSha256, children: /* @__PURE__ */ u(re, { style: { fontSize: 11 }, children: [
              h.definitionSha256.slice(0, 12),
              "…"
            ] }) }) }),
            /* @__PURE__ */ s(m.Td, { children: z !== 0 && /* @__PURE__ */ s(
              J,
              {
                size: "xs",
                variant: "light",
    ...
    /* @__PURE__ */ s(
      Te,
      {
        ...
        children: /* @__PURE__ */ s(I, { gap: "md", children: f ? /* @__PURE__ */ u(M, { justify: "center", py: "md", gap: "xs", children: [
          ...
          v.entries.length === 0 ? /* @__PURE__ */ s(B, { color: "green", title: "Identical", children: "Both definitions are structurally identical." }) : /* @__PURE__ */ s(is, { h: 420, children: /* @__PURE__ */ u(m, { verticalSpacing: "xs", striped: !0, children: [
            /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ u(m.Tr, { children: [
              /* @__PURE__ */ s(m.Th, { children: "Type" }),
              /* @__PURE__ */ s(m.Th, { children: "Where" }),
              /* @__PURE__ */ s(m.Th, { children: "What" }),
              /* @__PURE__ */ s(m.Th, { children: "Detail" })
            ] }) }),
            /* @__PURE__ */ s(m.Tbody, { children: v.entries.map((h, z) => /* @__PURE__ */ u(m.Tr, { children: [
              /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(ha, { kind: h.kind }) }),
              /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(re, { style: { fontSize: 11 }, children: h.path }) }),
              /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", children: h.label }) }),
              /* @__PURE__ */ u(m.Td, { children: [
...
function wa() {
  const [{ view: e, surveyId: r }, o] = j(() => Ir()), a = L((i, n) => {
    o((c) => ({
      view: i,
  ...
  const t = te(() => va.has(e) && r === null ? "list" : e, [e, r]);
  return R(() => {
    xa({ view: t, surveyId: t === e ? r : null });
    ...
    /* @__PURE__ */ u(
      H,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ s(H.Panel, { value: "list", pt: "md", children: /* @__PURE__ */ s(Sa, { onOpen: (i, n) => a(n, i) }) }),
          /* @__PURE__ */ s(H.Panel, { value: "designer", pt: "md", children: r !== null && /* @__PURE__ */ s(oa, { surveyId: r }) }),
          /* @__PURE__ */ s(H.Panel, { value: "responses", pt: "md", children: r !== null && /* @__PURE__ */ s(aa, { surveyId: r }) }),
          /* @__PURE__ */ s(H.Panel, { value: "dashboard", pt: "md", children: r !== null && /* @__PURE__ */ s(ya, { surveyId: r }) }),
          /* @__PURE__ */ s(H.Panel, { value: "versions", pt: "md", children: r !== null && /* @__PURE__ */ s(ja, { surveyId: r }) }),
...
function Sa({ onOpen: e }) {
  const [r, o] = j(null), [a, t] = j(null), [i, n] = j(!1), [c, d] = j(!1), [l, g] = j(null), [p, y] = j(null), [b, f] = j(""), k = oe(null), C = L(async () => {
    t(null);
    try {
      const T = await Kr();
      o(T);
  ...
  const E = L((T) => {
    ...
    n(!0);
    try {
      await Be(p, { name: T }), await C(), y(null), f("");
    } catch (_) {
  ...
  return /* @__PURE__ */ u(I, { gap: "sm", children: [
    /* @__PURE__ */ u(M, { justify: "space-between", children: [
      /* @__PURE__ */ u(M, { gap: "xs", children: [
        ...
        /* @__PURE__ */ s(W, { label: "Reload", children: /* @__PURE__ */ s(ae, { variant: "subtle", onClick: () => {
          C();
    ...
    r === null ? /* @__PURE__ */ u(M, { gap: "xs", justify: "center", py: "md", children: [
    ...
    ] }) : r.length === 0 ? /* @__PURE__ */ s(ce, { withBorder: !0, p: "lg", children: /* @__PURE__ */ u(I, { gap: "xs", align: "center", children: [
      /* @__PURE__ */ s(yo, { size: 32 }),
      ...
      /* @__PURE__ */ s(m.Thead, { children: /* @__PURE__ */ u(m.Tr, { children: [
        /* @__PURE__ */ s(m.Th, { children: "Name" }),
        /* @__PURE__ */ s(m.Th, { children: "Revision" }),
        /* @__PURE__ */ s(m.Th, { children: "Responses" }),
        /* @__PURE__ */ s(m.Th, { children: "Updated" }),
        /* @__PURE__ */ s(m.Th, { children: "State" }),
        /* @__PURE__ */ s(m.Th, { style: { width: 60 } })
      ] }) }),
      /* @__PURE__ */ s(m.Tbody, { children: r.map((T) => /* @__PURE__ */ s(
        ka,
        {
          survey: T,
          busy: i,
...
function ka({
  ...
  return /* @__PURE__ */ u(m.Tr, { onContextMenu: E, style: { cursor: o ? "text" : "default" }, children: [
    /* @__PURE__ */ u(m.Td, { children: [
    ...
    /* @__PURE__ */ s(m.Td, { children: e.currentRevision === null ? /* @__PURE__ */ s(x, { c: "dimmed", children: "draft" }) : /* @__PURE__ */ u(N, { variant: "light", children: [
      "v",
      e.currentRevision
    ] }) }),
    /* @__PURE__ */ s(m.Td, { children: e.responseCount }),
    /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ s(x, { size: "sm", children: new Date(e.updatedAt).toLocaleString() }) }),
    /* @__PURE__ */ s(m.Td, { children: e.archived ? /* @__PURE__ */ s(N, { color: "gray", variant: "light", children: "archived" }) : /* @__PURE__ */ s(N, { color: "green", variant: "light", children: "active" }) }),
    /* @__PURE__ */ s(m.Td, { children: /* @__PURE__ */ u(P, { shadow: "md", position: "bottom-end", withinPortal: !0, children: [
      ...
      /* @__PURE__ */ u(P.Dropdown, { children: [
        ...
        /* @__PURE__ */ s(
          P.Item,
          {
            leftSection: /* @__PURE__ */ s(Sr, { size: 14 }),
            onClick: p,
...
function Ca({ position: e, onClose: r, children: o }) {
  return R(() => {
    const a = (i) => {
      const n = i.target;
...
function Ta() {
  ...
  return R(() => {
    ...
    /* @__PURE__ */ u(M, { justify: "space-between", align: "center", children: [
      ...
      e === null ? /* @__PURE__ */ s(de, { size: "xs" }) : e.configured ? /* @__PURE__ */ s(N, { color: "green", variant: "light", children: "License configured" }) : /* @__PURE__ */ s(N, { color: "yellow", variant: "light", children: "License not configured" })
    ] }),
    ...
    Qo && /* @__PURE__ */ s(me, { withBorder: !0, p: "md", children: /* @__PURE__ */ u(I, { gap: 4, children: [
...
function za({ opened: e, onClose: r, onCreated: o }) {
...
function Ea({
  ...
  return R(() => {
    ...
    $r,
    {
      data: t.map((y) => ({
        value: y.surveyId,
        label: `${y.name} (${y.surveyId})${y.currentRevision ? ` · v${y.currentRevision}` : " · draft only"}`
      })),
      value: g,
      onChange: (y) => {
        const b = y ?? "";
...
const Rr = "sh2-shp-survey-js", Pa = "0.2.19", Aa = (e) => (Bs(e), rs({
  id: Rr,
  version: Pa,
  ...
  healthChecks: [
    {
      ...
      run: async () => {
        try {
          const r = await fetch(
            `/api/admin/plugins/${Rr}/license-key`,
            {
              credentials: "include",
              headers: { Accept: "application/json" }
            }
