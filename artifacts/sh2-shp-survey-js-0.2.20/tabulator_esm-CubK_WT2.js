...
let xe = class be extends k {
  ...
  containerEventCoords(e) {
    ...
    if (this.container !== document.body) {
      let n = E.elOffset(this.container);
      i -= n.left, s -= n.top;
    }
    return { x: i, y: s };
  }
  elementPositionCoords(e, t = "right") {
    var i = E.elOffset(e), s, n, r;
    switch (this.container !== document.body && (s = E.elOffset(this.container), i.left -= s.left, i.top -= s.top), t) {
      case "right":
  ...
  _fitToScreen(e, t, i, s, n) {
    ...
    t + this.element.offsetHeight > o && (i ? n === "bottom" ? this.element.style.top = parseInt(this.element.style.top) - this.element.offsetHeight - i.offsetHeight - 1 + "px" : this.element.style.top = parseInt(this.element.style.top) - this.element.offsetHeight + i.offsetHeight + 1 + "px" : this.element.style.height = o + "px");
  }
  isVisible() {
    return this.visible;
  }
  ...
  child(e) {
    return this.childPopup && this.childPopup.hide(), this.childPopup = new be(this.table, e, this), this.childPopup;
  }
};
class v extends k {
  constructor(e, t) {
...
class U extends v {
  ...
  lookupAccessor(e) {
    ...
    switch (typeof e) {
      case "string":
        U.accessors[e] ? t = U.accessors[e] : console.warn("Accessor Error - No such accessor found, ignoring: ", e);
        break;
      case "function":
        t = e;
        break;
  ...
  transformRow(e, t) {
    var i = "accessor" + (t.charAt(0).toUpperCase() + t.slice(1)), s = e.getComponent(), n = E.deepClone(e.data || {});
...
function se(l, e) {
  ...
  if (e = e || "", Array.isArray(l))
    l.forEach((s, n) => {
      t = t.concat(se(s, e ? e + "[" + n + "]" : n));
    });
  else if (typeof l == "object")
    for (var i in l)
      t = t.concat(se(l[i], e ? e + "[" + i + "]" : i));
  else
...
function ve(l, e, t) {
  return l && t && Object.keys(t).length && (!e.method || e.method.toLowerCase() == "get") && (e.method = "get", l += (l.includes("?") ? "&" : "?") + Me(t)), l;
}
function Le(l, e, t) {
  var i;
...
function ne(l, e) {
  ...
  if (e = e || "", Array.isArray(l))
    l.forEach((s, n) => {
      t = t.concat(ne(s, e ? e + "[" + n + "]" : n));
    });
  else if (typeof l == "object")
    for (var i in l)
      t = t.concat(ne(l[i], e ? e + "[" + i + "]" : i));
  else
    t.push({ key: e, value: l });
  return t;
}
...
class _ extends v {
  ...
  //load defaults
  static defaultConfig = ke;
  static defaultURLGenerator = ve;
  static defaultLoaderPromise = Le;
  static contentTypeFormatters = Se;
  constructor(e) {
    ...
    }), this.registerTableOption("ajaxResponse", !1), this.contentTypeFormatters = _.contentTypeFormatters;
  }
  ...
  setDefaultConfig(e = {}) {
    this.config = Object.assign({}, _.defaultConfig), typeof e == "string" ? this.config.method = e : Object.assign(this.config, e);
  }
  //load config object
  generateConfig(e = {}) {
...
class X extends v {
  ...
  //load defaults
  static pasteActions = De;
  static pasteParsers = ze;
  constructor(e) {
...
`);
  ...
  setPasteAction(e) {
    switch (typeof e) {
      case "string":
        this.pasteAction = X.pasteActions[e], this.pasteAction || console.warn("Clipboard Error - No such paste action found:", e);
        break;
      case "function":
        this.pasteAction = e;
        break;
  ...
  setPasteParser(e) {
    switch (typeof e) {
      case "string":
        this.pasteParser = X.pasteParsers[e], this.pasteParser || console.warn("Clipboard Error - No such paste parser found:", e);
        break;
      case "function":
        this.pasteParser = e;
        break;
...
class j extends k {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new we(this)), this.component;
  }
}
class Ce {
  constructor(e) {
...
class F extends k {
  ...
  mapDefinitions() {
    ...
    this.definition = this.table.columnManager.optionsList.generate(F.defaultOptionList, this.definition);
  }
  checkDefinition() {
    Object.keys(this.definition).forEach((e) => {
      F.defaultOptionList.indexOf(e) === -1 && console.warn("Invalid column definition option in '" + (this.field || this.definition.title) + "' column:", e);
    });
  }
  setField(e) {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new Ce(this)), this.component;
  }
  getPosition() {
    return this.table.columnManager.getVisibleColumnsByIndex().indexOf(this) + 1;
  }
  getParentComponent() {
    return this.parent instanceof F ? this.parent.getComponent() : !1;
  }
}
class Q {
  constructor(e) {
...
class M extends k {
  ...
  updateData(e) {
    var t = this.element && E.elVisible(this.element), i = {}, s;
    return new Promise((n, r) => {
      ...
      for (let a in e)
        this.table.columnManager.getColumnsByFieldRoot(a).forEach((d) => {
          ...
          if (u) {
            let c = d.getFieldValue(s);
            u.getValue() !== c && o.push([u, c]);
          }
        });
      for (let a in s)
        this.data[a] = s[a];
      this.dispatch("row-data-save-after", this), o.forEach(([a, h]) => {
        a.setValueProcessData(h), t && a.cellRendered();
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new Q(this)), this.component;
  }
}
var Oe = {
  avg: function(l, e, t) {
  ...
  concat: function(l, e, t) {
    var i = 0;
    return l.length && (i = l.reduce(function(s, n) {
      return String(s) + String(n);
    })), i;
  },
  count: function(l, e, t) {
    var i = 0;
    return l.length && l.forEach(function(s) {
      s && i++;
    }), i;
  },
  unique: function(l, e, t) {
    var i = l.filter((s, n) => (l || s === 0) && l.indexOf(s) === n);
    return i.length;
  }
};
class B extends v {
  ...
  initializeColumn(e) {
    ...
    if (t.topCalc) {
      switch (typeof t.topCalc) {
        case "string":
          B.calculations[t.topCalc] ? i.topCalc = B.calculations[t.topCalc] : console.warn("Column Calc Error - No such calculation found, ignoring: ", t.topCalc);
          break;
        case "function":
          i.topCalc = t.topCalc;
          break;
    ...
    if (t.bottomCalc) {
      switch (typeof t.bottomCalc) {
        case "string":
          B.calculations[t.bottomCalc] ? i.botCalc = B.calculations[t.bottomCalc] : console.warn("Column Calc Error - No such calculation found, ignoring: ", t.bottomCalc);
          break;
        case "function":
  ...
  rowsToData(e) {
    ...
    return e.forEach((n) => {
      t.push(n.getData()), i && n.modules.dataTree?.open && this.rowsToData(s.getFilteredTreeChildren(n)).forEach((r) => {
        t.push(n);
      });
    }), t;
  }
  ...
  generateRow(e, t) {
    ...
    return this.table.modExists("mutator") && this.table.modules.mutator.disable(), s = new M(i, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), s.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), s.component = !1, s.getComponent = () => (s.component || (s.component = new Pe(s)), s.component), s.generateCells = () => {
      var n = [];
...
class _e extends v {
  ...
  initializeRow(e) {
    ...
    !s && e.modules.dataTree && e.modules.dataTree.branchEl && e.modules.dataTree.branchEl.parentNode && e.modules.dataTree.branchEl.parentNode.removeChild(e.modules.dataTree.branchEl), !s && e.modules.dataTree && e.modules.dataTree.controlEl && e.modules.dataTree.controlEl.parentNode && e.modules.dataTree.controlEl.parentNode.removeChild(e.modules.dataTree.controlEl), e.modules.dataTree = {
  ...
  getRows(e) {
    ...
    return e.forEach((i, s) => {
      var n, r;
      t.push(i), i instanceof M && (i.create(), n = i.modules.dataTree, !n.index && n.children !== !1 && (r = this.getChildren(i, !1, !0), r.forEach((o) => {
        o.create(), t.push(o);
      })));
    }), t;
  }
  ...
  generateChildren(e) {
    ...
    return Array.isArray(i) || (i = [i]), i.forEach((s) => {
      var n = new M(s || {}, this.table.rowManager);
  ...
  getTreeChildren(e, t, i) {
    ...
    return s && s.children && (Array.isArray(s.children) || (s.children = this.generateChildren(e)), s.children.forEach((r) => {
      r instanceof M && (n.push(t ? r.getComponent() : r), i && this.getTreeChildren(r, t, i).forEach((o) => {
        n.push(o);
      }));
    })), n;
  }
...
function Ie(l, e = {}, t) {
  ...
  a.orientation || (a.orientation = e.orientation || "landscape"), a.unit || (a.unit = "pt"), l.forEach((f) => {
    switch (f.type) {
      case "header":
        i.push(c(f));
        break;
    ...
    return f.columns.forEach((b) => {
      ...
      if (b) {
        ...
        m = {
          ...
          colSpan: b.width,
          rowSpan: b.height
        }, p && (m.styles = p), g.push(m);
      }
    }), g;
  }
  d = this.dependencyRegistry.lookup("jspdf", "jsPDF"), u = new d(a), e.autoTable && (typeof e.autoTable == "function" ? n = e.autoTable(u) || {} : n = e.autoTable), h && (n.didDrawPage = function(f) {
    u.text(h, 40, 30);
  }), n.head = i, n.body = s, u.autoTable(n), e.documentProcessing && e.documentProcessing(u), t(u.output("arraybuffer"), "application/pdf");
}
function Ne(l, e, t) {
  var i = this, s = e.sheetName || "Sheet1", n = this.dependencyRegistry.lookup("XLSX"), r = n.utils.book_new(), o = new k(this), a = "compress" in e ? e.compress : !0, h = e.writeOptions || { bookType: "xlsx", bookSST: !0, compression: a }, d;
  h.type = "binary", r.SheetNames = [], r.Sheets = {};
  function u() {
    var p = [], g = [], b = {}, m = { s: { c: 0, r: 0 }, e: { c: l[0] ? l[0].columns.reduce((w, R) => w + (R && R.width ? R.width : 1), 0) : 0, r: l.length } };
    return l.forEach((w, R) => {
      var T = [];
      w.columns.forEach(function(y, L) {
        y ? (T.push(!(y.value instanceof Date) && typeof y.value == "object" ? JSON.stringify(y.value) : y.value), (y.width > 1 || y.height > -1) && (y.height > 1 || y.width > 1) && g.push({ s: { r: R, c: L }, e: { r: R + y.height - 1, c: L + y.width - 1 } })) : T.push("");
      }), p.push(T);
    }), n.utils.sheet_add_aoa(b, p), b["!ref"] = n.utils.encode_range(m), g.length && (b["!merges"] = g), b;
  }
  if (e.sheetOnly) {
    t(u());
    return;
  ...
  if (e.sheets)
    for (var c in e.sheets)
      e.sheets[c] === !0 ? (r.SheetNames.push(c), r.Sheets[c] = u()) : (r.SheetNames.push(c), o.commsSend(e.sheets[c], "download", "intercept", {
        type: "xlsx",
        options: { sheetOnly: !0 },
        active: i.active,
    ...
    r.SheetNames.push(s), r.Sheets[s] = u();
  e.documentProcessing && (r = e.documentProcessing(r));
  function f(p) {
    for (var g = new ArrayBuffer(p.length), b = new Uint8Array(g), m = 0; m != p.length; ++m) b[m] = p.charCodeAt(m) & 255;
    return g;
  }
...
class K extends v {
  ...
  download(e, t, i, s, n) {
    ...
    if (typeof e == "function" ? r = e : K.downloaders[e] ? r = K.downloaders[e] : console.warn("Download Error - No such download type found: ", e), r) {
  ...
  commsReceived(e, t, i) {
    t === "intercept" && this.download(i.type, "", i.options, i.active, i.intercept);
  }
}
function Z(l, e) {
  ...
  l.addEventListener("keydown", (o) => {
    ...
    o.key.length === 1 && e.maskAutoFill && r(l.value.length);
  }), l.placeholder || (l.placeholder = t), e.maskAutoFill && r(l.value.length);
}
function Ue(l, e, t, i, s) {
  ...
  return a.addEventListener("change", d), a.addEventListener("blur", d), a.addEventListener("keyup", function() {
    ...
    switch (u.key) {
      ...
      case "Escape":
        ...
        break;
      case "ArrowUp":
        (r == "editor" || r == "hybrid" && a.selectionStart) && (u.stopImmediatePropagation(), u.stopPropagation());
        break;
      case "ArrowDown":
        (r == "editor" || r == "hybrid" && a.selectionStart !== a.value.length) && (u.stopImmediatePropagation(), u.stopPropagation());
        break;
      case "End":
      case "Home":
        u.stopPropagation();
...
function qe(l, e, t, i, s) {
  ...
  function d(c) {
    var f;
    return o.isDateTime(c) ? f = c : n === "iso" ? f = o.fromISO(String(c)) : f = o.fromFormat(String(c), n), f.toFormat("yyyy-MM-dd");
  }
  ...
  function u() {
    ...
    if ((a === null || typeof a > "u") && c !== "" || c !== a) {
      if (c && n)
        switch (f = o.fromFormat(String(c), "yyyy-MM-dd"), n) {
          case !0:
            c = f;
            break;
          case "iso":
  ...
  return h.addEventListener("blur", function(c) {
    ...
    switch (c.key) {
      ...
      case "ArrowUp":
      case "ArrowDown":
        r == "editor" && (c.stopImmediatePropagation(), c.stopPropagation());
        break;
    }
  }), h;
}
function Ye(l, e, t, i, s) {
  ...
  function u() {
    ...
    if ((h === null || typeof h > "u") && c !== "" || c !== h) {
      if (c && n)
        switch (f = o.fromFormat(String(c), "hh:mm"), n) {
          case !0:
            c = f;
            break;
          case "iso":
...
let Qe = class {
  ...
  _createInputElement() {
    ...
    return this.params.mask && Z(t, this.params), this._bindInputEvents(t), t;
  }
  _initializeParams(e) {
  ...
  _ajaxRequest(e, t) {
    ...
    return e = ve(e, {}, i), fetch(e).then((s) => s.ok ? s.json().catch((n) => (console.warn("List Ajax Load Error - Invalid JSON returned", n), Promise.reject(n))) : (console.error("List Ajax Load Error - Connection Error: " + s.status, s.statusText), Promise.reject(s))).catch((s) => (console.error("List Ajax Load Error - Connection Error: ", s), Promise.reject(s)));
  }
  ...
  _defaultSortFunction(e, t) {
    var i, s, n, r, o = 0, a, h = /(\d+)|(\D+)/g, d = /\d/, u = 0;
...
function Ze(l, e, t, i, s) {
  var n = new Qe(this, l, e, t, i, s);
  return n.input;
}
function et(l, e, t, i, s) {
...
function tt(l, e, t, i, s) {
  var n = l.getElement(), r = typeof s.max > "u" ? n.getElementsByTagName("div")[0] && n.getElementsByTagName("div")[0].getAttribute("max") || 100 : s.max, o = typeof s.min > "u" ? n.getElementsByTagName("div")[0] && n.getElementsByTagName("div")[0].getAttribute("min") || 0 : s.min, a = (r - o) / 100, h = l.getValue() || 0, d = document.createElement("div"), u = document.createElement("div"), c, f;
  function p() {
    var g = window.getComputedStyle(n, null), b = a * Math.round(u.offsetWidth / ((n.clientWidth - parseInt(g.getPropertyValue("padding-left")) - parseInt(g.getPropertyValue("padding-right"))) / 100)) + o;
  ...
  if (d.style.position = "absolute", d.style.right = "0", d.style.top = "0", d.style.bottom = "0", d.style.width = "5px", d.classList.add("tabulator-progress-handle"), u.style.display = "inline-block", u.style.position = "relative", u.style.height = "100%", u.style.backgroundColor = "#488CE9", u.style.maxWidth = "100%", u.style.minWidth = "0%", s.elementAttributes && typeof s.elementAttributes == "object")
    for (let g in s.elementAttributes)
      g.charAt(0) == "+" ? (g = g.slice(1), u.setAttribute(g, u.getAttribute(g) + s.elementAttributes["+" + g])) : u.setAttribute(g, s.elementAttributes[g]);
  return n.style.padding = "4px 4px", h = Math.min(parseFloat(h), r), h = Math.max(parseFloat(h), o), h = Math.round((h - o) / a), u.style.width = h + "%", n.setAttribute("aria-valuemin", o), n.setAttribute("aria-valuemax", r), u.appendChild(d), d.addEventListener("mousedown", function(g) {
    c = g.screenX, f = u.offsetWidth;
  }), d.addEventListener("mouseover", function() {
    d.style.cursor = "ew-resize";
  }), n.addEventListener("mousemove", function(g) {
    c && (u.style.width = f + g.screenX - c + "px");
  }), n.addEventListener("mouseup", function(g) {
    c && (g.stopPropagation(), g.stopImmediatePropagation(), c = !1, f = !1, p());
  }), n.addEventListener("keydown", function(g) {
    switch (g.key) {
      case "ArrowRight":
        g.preventDefault(), u.style.width = u.clientWidth + n.clientWidth / 100 + "px";
        break;
      case "ArrowLeft":
        g.preventDefault(), u.style.width = u.clientWidth - n.clientWidth / 100 + "px";
        break;
...
function it(l, e, t, i, s) {
  var n = l.getValue(), r = document.createElement("input"), o = s.tristate, a = typeof s.indeterminateValue > "u" ? null : s.indeterminateValue, h = !1, d = Object.keys(s).includes("trueValue"), u = Object.keys(s).includes("falseValue");
  ...
  function c(f) {
    var p = r.checked;
    return d && p ? p = s.trueValue : u && !p && (p = s.falseValue), o ? f ? h ? a : p : r.checked && !h ? (r.checked = !1, r.indeterminate = !0, h = !0, a) : (h = !1, p) : p;
  }
  return r.addEventListener("change", function(f) {
    ...
    f.key == "Enter" && t(c()), f.key == "Escape" && i();
  }), r;
}
function st(l, e, t, i, s) {
  ...
  findNextEditableCell(e, t) {
    ...
    if (t < e.cells.length - 1)
      for (var s = t + 1; s < e.cells.length; s++) {
        let n = e.cells[s];
        if (n.column.modules.edit && E.elVisible(n.getElement()) && this.allowEdit(n)) {
          i = n;
          break;
        }
      }
  ...
  edit(e, t, i) {
    ...
    function c(m) {
      if (s.currentCell === e && !a) {
        var w = s.chain("edit-success", [e, m], !0, !0);
        return w === !0 || s.table.options.validationMode === "highlight" ? (a = !0, s.clearEditor(), e.modules.edit || (e.modules.edit = {}), e.modules.edit.edited = !0, s.editedCells.indexOf(e) == -1 && s.editedCells.push(e), m = s.transformEmptyValues(m, e), e.setValue(m, !0), w === !0) : (a = !0, s.invalidEdit = !0, s.focusCellNoEvent(e, !0), r(), setTimeout(() => {
          a = !1;
        }, 10), !1);
      }
    }
    ...
    if (t && t.stopPropagation(), n = this.allowEdit(e), n || i) {
      if (s.cancelEdit(), s.currentCell = e, this.focusScrollAdjust(e), d = e.getComponent(), this.mouseClick && (this.mouseClick = !1, e.column.definition.cellClick && e.column.definition.cellClick.call(this.table, t, d)), e.column.definition.cellEditing && e.column.definition.cellEditing.call(this.table, d), this.dispatch("cell-editing", e), this.dispatchExternal("cellEditing", d), u = typeof e.column.modules.edit.params == "function" ? e.column.modules.edit.params(d) : e.column.modules.edit.params, h = e.column.modules.edit.editor.call(s, d, p, c, f, u), this.currentCell && h !== !1)
        if (h instanceof Node) {
          ...
          o.appendChild(h), r();
          for (var g = o.children, b = 0; b < g.length; b++)
            g[b].addEventListener("click", function(m) {
              m.stopPropagation();
            });
        } else
...
class N extends v {
  ...
  static columnLookups = rt;
  static rowLookups = ot;
  constructor(e) {
  ...
  generateExportList(e, t, i, s) {
    var n, r, o, a;
    return this.cloneTableStyle = t, this.config = e || {}, this.colVisProp = s, this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1), a = N.columnLookups[i], a && (o = a.call(this.table), o = o.filter((h) => this.columnVisCheck(h))), n = this.config.columnHeaders !== !1 ? this.headersToExportRows(this.generateColumnGroupHeaders(o)) : [], o && (o = o.map((h) => h.getComponent())), r = this.bodyToExportRows(this.rowLookup(i), o), n.concat(r);
  }
  ...
  rowLookup(e) {
    ...
    }) : (i = N.rowLookups[e] || N.rowLookups.active, t = i.call(this.table)), Object.assign([], t);
  }
    ...
    return e.forEach(function(r) {
      ...
      r.forEach((a) => {
        if (a) {
          ...
          o.push(new te(h, a.column.getComponent(), a.width, a.height, a.depth));
        } else
          o.push(null);
      }), s.push(new pe("header", o));
    }), s;
  }
  bodyToExportRows(e, t = []) {
    ...
    return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((s) => {
      ...
      switch (s.type) {
        case "group":
          a = s.level, o.push(new te(s.key, s.getComponent(), t.length, 1));
          break;
        case "calc":
        case "row":
          t.forEach((h) => {
            o.push(new te(h._column.getFieldValue(r), h, 1, 1));
          }), this.table.options.dataTree && this.config.dataTree !== !1 && (a = s.modules.dataTree.index);
          break;
      }
      i.push(new pe(s.type, o, s.getComponent(), a));
    }), i;
  }
  ...
  generateRowElement(e, t, i) {
    ...
    if (s.classList.add("tabulator-print-table-row"), e.columns.forEach((n, r) => {
      if (n) {
        var o = document.createElement("td"), a = n.component._column, h = this.table, d = h.columnManager.findColumnIndex(a), u = n.value, c, f, p = {
          modules: {},
          getValue: function() {
            return u;
          },
          ...
          column: a
        }, g = a.definition.cssClass ? a.definition.cssClass.split(" ") : [];
...
var at = {
  ...
  regex: function(l, e, t, i) {
    return typeof l == "string" && (l = new RegExp(l)), l.test(e);
  },
  //contains the string
  like: function(l, e, t, i) {
    return l === null || typeof l > "u" ? e === l : typeof e < "u" && e !== null ? String(e).toLowerCase().indexOf(l.toLowerCase()) > -1 : !1;
  },
  ...
  starts: function(l, e, t, i) {
    return l === null || typeof l > "u" ? e === l : typeof e < "u" && e !== null ? String(e).toLowerCase().startsWith(l.toLowerCase()) : !1;
  },
  //ends with the string
  ends: function(l, e, t, i) {
    return l === null || typeof l > "u" ? e === l : typeof e < "u" && e !== null ? String(e).toLowerCase().endsWith(l.toLowerCase()) : !1;
  },
  //in array
  in: function(l, e, t, i) {
...
class P extends v {
        ...
        if (e.modules.filter.prevSuccess = r, e.modules.filter.emptyFunc(r))
          ...
          switch (e.modules.filter.value = r, typeof e.definition.headerFilterFunc) {
            ...
            case "function":
              d = function(u) {
                var c = e.definition.headerFilterFuncParams || {}, f = e.getFieldValue(u);
                return c = typeof c == "function" ? c(r, f, u) : c, e.definition.headerFilterFunc(r, f, u, c);
              }, a = d;
              break;
          }
          d || (o === "partial" ? (d = function(u) {
            var c = e.getFieldValue(u);
            return typeof c < "u" && c !== null ? String(c).toLowerCase().indexOf(String(r).toLowerCase()) > -1 : !1;
          }, a = "like") : (d = function(u) {
            return e.getFieldValue(u) == r;
          }, a = "=")), i.headerFilters[s] = { value: r, func: d, type: a };
        }
  ...
  generateHeaderFilterElement(e, t, i) {
    var s = this, n = e.modules.filter.success, r = e.getField(), o, a, h, d, u, c, f, p;
    ...
    if (e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), r) {
      switch (e.modules.filter.emptyFunc = e.definition.headerFilterEmptyCheck || function(m) {
        ...
        case "string":
          s.table.modules.edit.editors[e.definition.headerFilter] ? (a = s.table.modules.edit.editors[e.definition.headerFilter], (e.definition.headerFilter === "tick" || e.definition.headerFilter === "tickCross") && !e.definition.headerFilterEmptyCheck && (e.modules.filter.emptyFunc = function(m) {
            return m !== !0 && m !== !1;
      ...
      if (a) {
        ...
        }, f = e.definition.headerFilterParams || {}, f = typeof f == "function" ? f.call(s.table, d) : f, h = a.call(this.table.modules.edit, d, b, n, g, f), !h) {
        ...
        s.langBind("headerFilters|columns|" + e.definition.field, function(m) {
          ...
          var w = this.table.columnManager.contentsElement.scrollLeft, R = this.table.rowManager.element.scrollLeft;
          w !== R && (this.table.rowManager.scrollHorizontal(w), this.table.columnManager.scrollHorizontal(w));
        }), u = !1, c = function(m) {
...
function ut(l, e, t) {
  var i = parseFloat(l.getValue()), s = "", n, r, o, a, h, d = e.decimal || ".", u = e.thousand || ",", c = e.negativeSign || "-", f = e.symbol || "", p = !!e.symbolAfter, g = typeof e.precision < "u" ? e.precision : 2;
  if (isNaN(i))
    return this.emptyToSpace(this.sanitizeHTML(l.getValue()));
  if (i < 0 && (i = Math.abs(i), s = c), n = g !== !1 ? i.toFixed(g) : i, n = String(n).split("."), r = n[0], o = n.length > 1 ? d + n[1] : "", e.thousand !== !1)
    for (a = /(\d+)(\d{3})/; a.test(r); )
      r = r.replace(a, "$1" + u + "$2");
  return h = r + o, s === !0 ? (h = "(" + h + ")", p ? h + f : f + h) : p ? s + h + f : s + f + h;
}
function ct(l, e, t) {
  ...
  if (r) {
    if (e.urlField && (a = l.getData(), i = E.retrieveNestedData(this.table.options.nestedFieldSeparator, e.urlField, a)), e.url)
      switch (typeof e.url) {
        case "string":
          i = e.url;
          break;
...
function gt(l, e, t) {
  ...
  if (typeof i < "u") {
    var u;
    return i.isDateTime(d) ? u = d : s === "iso" ? u = i.fromISO(String(d)) : u = i.fromFormat(String(d), s), u.isValid ? a ? u.diff(h, o).toHuman() + (r ? " " + r : "") : parseInt(u.diff(h, o)[o]) + (r ? " " + r : "") : n === !0 ? d : typeof n == "function" ? n(d) : n;
  } else
...
function vt(l, e, t) {
  ...
  for (var d = 1; d <= n; d++) {
    var u = o.cloneNode(!0);
    u.innerHTML = d <= i ? a : h, r.appendChild(u);
  }
...
function wt(l, e, t) {
  ...
  if (!(isNaN(i) || typeof l.getValue() > "u")) {
    switch (s.classList.add("tabulator-traffic-light"), d = parseFloat(i) <= n ? parseFloat(i) : n, d = parseFloat(d) >= r ? parseFloat(d) : r, h = (n - r) / 100, d = Math.round((d - r) / h), typeof o) {
      ...
      case "object":
        if (Array.isArray(o)) {
          var u = 100 / o.length, c = Math.floor(d / u);
...
function Ct(l, e = {}, t) {
  ...
  switch (h = parseFloat(i) <= n ? parseFloat(i) : n, h = parseFloat(h) >= r ? parseFloat(h) : r, a = (n - r) / 100, h = Math.round((h - r) / a), typeof e.color) {
    ...
    case "object":
      if (Array.isArray(e.color)) {
        let b = 100 / e.color.length, m = Math.floor(h / b);
        m = Math.min(m, e.color.length - 1), m = Math.max(m, 0), d = e.color[m];
        break;
      }
    default:
      d = "#2DC214";
  ...
  switch (typeof e.legendColor) {
    ...
    case "object":
      if (Array.isArray(e.legendColor)) {
        let b = 100 / e.legendColor.length, m = Math.floor(h / b);
        m = Math.min(m, e.legendColor.length - 1), m = Math.max(m, 0), c = e.legendColor[m];
      }
      break;
    default:
      c = "#000";
  ...
  if (p.style.position = "relative", p.style.width = "100%", p.style.height = "100%", u) {
    ...
    g.style.position = "absolute", g.style.top = 0, g.style.left = 0, g.style.textAlign = o, g.style.width = "100%", g.style.color = c, g.innerHTML = u;
  }
  return t(function() {
    if (!(l instanceof we)) {
...
function Lt(l, e, t) {
  ...
  return e.valueMap && (typeof e.valueMap == "string" ? r = function(o) {
    return o.map((a) => E.retrieveNestedData(n.options.nestedFieldSeparator, e.valueMap, a));
...
class V extends v {
  ...
  lookupFormatter(e) {
    ...
    switch (typeof e) {
      case "string":
        V.formatters[e] ? t = V.formatters[e] : (console.warn("Formatter Error - No such formatter found: ", e), t = V.formatters.plaintext);
        break;
      case "function":
        t = e;
        break;
      default:
        t = V.formatters.plaintext;
        break;
    }
    return t;
  }
...
class I {
  ...
  _createGroup(e, t) {
    var i = t + "_" + e, s = new I(this.groupManager, this, t, e, this.groupManager.groupIDLookups[t].field, this.groupManager.headerGenerator[t] || this.groupManager.headerGenerator[0], this.old ? this.old.groups[i] : !1);
  ...
  reinitialize() {
    this.initialized = !1, this.height = 0, E.elVisible(this.element) && this.initialize(!0);
  }
  setHeight(e) {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new Ft(this)), this.component;
  }
}
class At extends v {
  ...
  rowMoving(e, t, i) {
    if (this.table.options.groupBy) {
      !i && t instanceof I && (t = this.table.rowManager.prevDisplayRow(e) || t);
      var s = t instanceof I ? t : t.modules.group, n = e instanceof I ? e : e.modules.group;
  ...
  createGroup(e, t, i) {
    var s = t + "_" + e, n;
    i = i || [], n = new I(this, !1, t, e, this.groupIDLookups[0].field, this.headerGenerator[0], i[s]), this.groups[s] = n, this.groupList.push(n);
  }
...
var Pt = {
  ...
  rowAdd: function(l) {
    l.component.deleteActual(), this.table.rowManager.checkPlaceholder();
  },
  rowDelete: function(l) {
    var e = this.table.rowManager.addRowActual(l.data.data, l.data.pos, l.data.index);
    this.table.options.groupBy && this.table.modExists("groupRows") && this.table.modules.groupRows.updateGroupRows(!0), this._rebindRow(l.component, e), this.table.rowManager.checkPlaceholder();
  },
  rowMove: function(l) {
...
class J extends v {
  ...
  undo() {
    if (this.index > -1) {
      ...
      return J.undoers[e.type].call(this, e), this.index--, this.dispatchExternal("historyUndo", e.type, e.component.getComponent(), e.data), !0;
    } else
  ...
  redo() {
    if (this.history.length - 1 > this.index) {
      this.index++;
      let e = this.history[this.index];
      return J.redoers[e.type].call(this, e), this.dispatchExternal("historyRedo", e.type, e.component.getComponent(), e.data), !0;
    } else
  ...
  _rebindRow(e, t) {
    this.history.forEach(function(i) {
      if (i.component instanceof M)
        i.component === e && (i.component = t);
      else if (i.component instanceof j && i.component.row === e) {
...
class oe extends v {
  ...
  lookupImporter(e) {
    var t;
    return e || (e = this.table.options.importFormat), typeof e == "string" ? t = oe.importers[e] : t = e, t || console.error("Import Error - Importer not found:", e), t;
  }
...
class Xt extends v {
  ...
  dispatchEvent(e, t, i) {
    ...
    this.columnSubscribers[e] && (i instanceof j ? n = i.column.definition[e] : i instanceof F && (n = i.definition[e]), n && n(t, s)), this.dispatchExternal(e, t, s);
  }
}
var Kt = {
  navPrev: "shift + 9",
  ...
  scrollPageUp: function(l) {
    var e = this.table.rowManager, t = e.scrollTop - e.element.clientHeight;
    l.preventDefault(), e.displayRowsCount && (t >= 0 ? e.element.scrollTop = t : e.scrollToRow(e.getDisplayRows()[0])), this.table.element.focus();
  },
  scrollPageDown: function(l) {
    var e = this.table.rowManager, t = e.scrollTop + e.element.clientHeight, i = e.element.scrollHeight;
    l.preventDefault(), e.displayRowsCount && (t <= i ? e.element.scrollTop = t : e.scrollToRow(e.getDisplayRows()[e.displayRowsCount - 1])), this.table.element.focus();
  },
  scrollToStart: function(l) {
    var e = this.table.rowManager;
    l.preventDefault(), e.displayRowsCount && e.scrollToRow(e.getDisplayRows()[0]), this.table.element.focus();
  },
  scrollToEnd: function(l) {
    var e = this.table.rowManager;
    l.preventDefault(), e.displayRowsCount && e.scrollToRow(e.getDisplayRows()[e.displayRowsCount - 1]), this.table.element.focus();
  },
  navPrev: function(l) {
    this.dispatch("keybinding-nav-prev", l);
  },
  navNext: function(l) {
    this.dispatch("keybinding-nav-next", l);
  },
  navLeft: function(l) {
    this.dispatch("keybinding-nav-left", l);
  },
  navRight: function(l) {
    this.dispatch("keybinding-nav-right", l);
  },
  navUp: function(l) {
    this.dispatch("keybinding-nav-up", l);
  },
  navDown: function(l) {
...
class W extends v {
  ...
  initialize() {
    ...
    this.watchKeys = {}, this.pressedKeys = [], e !== !1 && (Object.assign(t, W.bindings), Object.assign(t, e), this.mapBindings(t), this.bindEvents()), this.subscribe("table-destroy", this.clearBindings.bind(this));
  }
  mapBindings(e) {
    for (let t in e)
      W.actions[t] ? e[t] && (typeof e[t] != "object" && (e[t] = [e[t]]), e[t].forEach((i) => {
  ...
  bindEvents() {
    ...
    this.keyupBinding = function(t) {
      var i = e.getKeyCode(t), s = e.watchKeys[i];
...
class Yt extends v {
  ...
  initializeColumn(e) {
    ...
    !e.modules.frozen && !e.isGroup && !e.isRowHeader && (s = e.getElement(), i.mousemove = function(n) {
      e.parent === t.moving.parent && ((t.touchMove ? n.touches[0].pageX : n.pageX) - E.elOffset(s).left + t.table.columnManager.contentsElement.scrollLeft > e.getWidth() / 2 ? (t.toCol !== e || !t.toColAfter) && (s.parentNode.insertBefore(t.placeholderElement, s.nextSibling), t.moveColumn(e, !0)) : (t.toCol !== e || t.toColAfter) && (s.parentNode.insertBefore(t.placeholderElement, s), t.moveColumn(e, !1)));
  ...
  bindTouchEvents(e) {
    ...
    t.addEventListener("touchstart", (d) => {
      ...
      var u, c;
      this.moving && (this.moveHover(d), i || (i = d.touches[0].pageX), u = d.touches[0].pageX - i, u > 0 ? s && u - a > r && (c = s, c !== e && (i = d.touches[0].pageX, c.getElement().parentNode.insertBefore(this.placeholderElement, c.getElement().nextSibling), this.moveColumn(c, !0))) : n && -u - h > o && (c = n, c !== e && (i = d.touches[0].pageX, c.getElement().parentNode.insertBefore(this.placeholderElement, c.getElement()), this.moveColumn(c, !1))), c && (s = c.nextColumn(), a = r, r = s ? s.getWidth() / 2 : 0, n = c.prevColumn(), h = o, o = n ? n.getWidth() / 2 : 0));
  ...
  moveHover(e) {
    var t = this.table.columnManager.getContentsElement(), i = t.scrollLeft, s = (this.touchMove ? e.touches[0].pageX : e.pageX) - E.elOffset(t).left + i, n;
...
var $t = {
  ...
  add: function(l, e, t) {
    return this.table.addRow(l.getData()), !0;
  },
  update: function(l, e, t) {
    return e ? (e.update(l.getData()), !0) : !1;
  },
  replace: function(l, e, t) {
...
class q extends v {
  ...
  initializeGroupHeader(e) {
    ...
    i.mouseup = function(s) {
      ...
      var n;
      s.pageY - E.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (n = e.getElement(), n.parentNode.insertBefore(t.placeholderElement, n.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (n = e.getElement(), n.previousSibling && (n.parentNode.insertBefore(t.placeholderElement, n), t.moveRow(e, !1)));
  ...
  initializeRow(e) {
    ...
    i.mouseup = function(n) {
      ...
      var r = e.getElement();
      n.pageY - E.elOffset(r).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2 ? (t.toRow !== e || !t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r.nextSibling), t.moveRow(e, !0)) : (t.toRow !== e || t.toRowAfter) && (r.parentNode.insertBefore(t.placeholderElement, r), t.moveRow(e, !1));
  ...
  dropComplete(e, t, i) {
    ...
    if (i) {
      switch (typeof this.table.options.movableRowsSender) {
        case "string":
          s = q.senders[this.table.options.movableRowsSender];
          break;
        case "function":
  ...
  tableRowDrop(e, t) {
    ...
    switch (e.stopImmediatePropagation(), typeof this.table.options.movableRowsReceiver) {
      case "string":
        i = q.receivers[this.table.options.movableRowsReceiver];
        break;
      case "function":
...
class Y extends v {
  ...
  lookupMutator(e) {
    ...
    switch (typeof e) {
      case "string":
        Y.mutators[e] ? t = Y.mutators[e] : console.warn("Mutator Error - No such mutator found, ignoring: ", e);
        break;
      case "function":
        t = e;
        break;
...
class ae extends v {
  ...
  initializePageCounter() {
    ...
    e && (typeof e == "function" ? t = e : t = ae.pageCounters[e], t ? (this.pageCounter = t, this.pageCounterElement = document.createElement("span"), this.pageCounterElement.classList.add("tabulator-page-counter")) : console.warn("Pagination Error - No such page counter found: ", e));
  }
  //setup pagination
    ...
    this.currentVersion++, i = this.currentVersion, this.unwatchData(), this.data = e, this.origFuncs.push = e.push, Object.defineProperty(this.data, "push", {
      ...
      value: function() {
        ...
        if (!t.blocked && i === t.currentVersion) {
          if (t.block("data-splice"), o && (a = e[n] ? t.table.rowManager.getRowFromDataObject(e[n]) : !1, a ? o.forEach((u) => {
...
class di extends v {
  ...
  initializeVisibilityObserver() {
    this.visibilityObserver = new IntersectionObserver((e) => {
      this.visible = e[e.length - 1].isIntersecting, this.initialized ? this.visible && (this.redrawTable(this.initialRedraw), this.initialRedraw = !1) : (this.initialized = !0, this.initialRedraw = !this.visible);
...
var ci = {
  format: {
    formatters: {
      responsiveCollapse: ui
    }
  }
};
class fi extends v {
  static moduleName = "responsiveLayout";
  static moduleExtensions = ci;
  constructor(e) {
...
function pi(l, e, t) {
  ...
  if (i.type = "checkbox", i.setAttribute("aria-label", "Select Row"), this.table.modExists("selectRow", !0))
    if (i.addEventListener("click", (r) => {
      ...
      var n = l.getRow();
      n instanceof Q ? (i.addEventListener("change", (r) => {
...
class vi extends k {
  constructor(e, t, i, s) {
    ...
    }, this.destroyed = !1, this.top = 0, this.bottom = 0, this.left = 0, this.right = 0, this.table = e, this.start = { row: void 0, col: void 0 }, this.end = { row: void 0, col: void 0 }, this.rangeManager.rowHeader && (this.left = 1, this.right = 1, this.start.col = 1, this.end.col = 1), this.initElement(), setTimeout(() => {
      this.initBounds(i, s);
    });
  }
  initElement() {
  ...
  ///////////////////////////////////
  layout() {
    var e = this.table.rowManager.renderer.vDomTop, t = this.table.rowManager.renderer.vDomBottom, i = this.table.columnManager.renderer.leftCol, s = this.table.columnManager.renderer.rightCol, n, r, o, a, h, d, u, c, f, p;
...
var wi = {
  ...
  rangeJumpRight: function(l) {
    this.dispatch("keybinding-nav-range", l, "right", !0, !1);
  },
  rangeJumpUp: function(l) {
    this.dispatch("keybinding-nav-range", l, "up", !0, !1);
  },
  rangeJumpDown: function(l) {
    this.dispatch("keybinding-nav-range", l, "down", !0, !1);
  },
  rangeExpandLeft: function(l) {
    this.dispatch("keybinding-nav-range", l, "left", !1, !0);
  },
  rangeExpandRight: function(l) {
    this.dispatch("keybinding-nav-range", l, "right", !1, !0);
  },
  rangeExpandUp: function(l) {
    this.dispatch("keybinding-nav-range", l, "up", !1, !0);
  },
  rangeExpandDown: function(l) {
    this.dispatch("keybinding-nav-range", l, "down", !1, !0);
  },
  rangeExpandJumpLeft: function(l) {
    this.dispatch("keybinding-nav-range", l, "left", !0, !0);
  },
  rangeExpandJumpRight: function(l) {
    this.dispatch("keybinding-nav-range", l, "right", !0, !0);
  },
  rangeExpandJumpUp: function(l) {
    this.dispatch("keybinding-nav-range", l, "up", !0, !0);
  },
...
class ki extends v {
  ...
  ///////////////////////////////////
  keyNavigate(e, t) {
    if (this.options("selectableRangeBlurEditOnNavigate") && this.chain("edit-check-editing"))
      if (e === "next" || e === "prev")
  ...
  navigate(e, t, i) {
    ...
    return this.rowHeader && h === 0 && (h = 1), t || n.setStart(a, h), n.setEnd(a, h), t || (this.selecting = "cell"), s = o.top !== n.top || o.bottom !== n.bottom || o.left !== n.left || o.right !== n.right, s && (d = this.getRowByRangePos(n.end.row), u = this.getColumnByRangePos(n.end.col), c = d.getElement().getBoundingClientRect(), p = u.getElement().getBoundingClientRect(), f = this.table.rowManager.getElement().getBoundingClientRect(), g = this.table.columnManager.getElement().getBoundingClientRect(), c.top >= f.top && c.bottom <= f.bottom || (d.getElement().parentNode && u.getElement().parentNode ? this.autoScroll(n, d.getElement(), u.getElement()) : d.getComponent().scrollTo(void 0, !1)), p.left >= g.left + this.getRowHeaderWidth() && p.right <= g.right || (d.getElement().parentNode && u.getElement().parentNode ? this.autoScroll(n, d.getElement(), u.getElement()) : u.getComponent().scrollTo(void 0, !1)), this.layoutElement()), !0;
  }
  rangeRemoved(e) {
    this.ranges = this.ranges.filter((t) => t !== e), this.activeRange === e && (this.ranges.length ? this.activeRange = this.ranges[this.ranges.length - 1] : this.addRange()), this.layoutElement(!0);
  }
  ...
  addRange(e, t) {
    var i;
    return this.maxRanges !== !0 && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), i = new vi(this.table, this, e, t), this.activeRange = i, this.ranges.push(i), this.rangeContainer.appendChild(i.element), i;
  }
  resetRanges() {
    var e, t, i;
...
function Si(l, e, t, i, s, n, r) {
  return r.format || (r.format = "dd/MM/yyyy"), le.call(this, l, e, t, i, s, n, r);
}
function Di(l, e, t, i, s, n, r) {
  return r.format || (r.format = "HH:mm"), le.call(this, l, e, t, i, s, n, r);
}
function zi(l, e, t, i, s, n, r) {
  var o = l === !0 || l === "true" || l === "True" || l === 1 ? 1 : 0, a = e === !0 || e === "true" || e === "True" || e === 1 ? 1 : 0;
  return o - a;
}
function Hi(l, e, t, i, s, n, r) {
  var o = r.type || "length", a = r.alignEmptyValues, h = 0, d = this.table, u;
  r.valueMap && (typeof r.valueMap == "string" ? u = function(f) {
    return f.map((p) => E.retrieveNestedData(d.options.nestedFieldSeparator, r.valueMap, p));
  } : u = r.valueMap);
  function c(f) {
    var p;
    switch (u && (f = u(f)), o) {
  ...
  if (!Array.isArray(l))
    ...
    return o === "string" ? String(c(l)).toLowerCase().localeCompare(String(c(e)).toLowerCase()) : c(e) - c(l);
  return (a === "top" && n === "desc" || a === "bottom" && n === "asc") && (h *= -1), h;
}
function Fi(l, e, t, i, s, n, r) {
  var o = typeof l > "u" ? 0 : 1, a = typeof e > "u" ? 0 : 1;
  return o - a;
}
function Ai(l, e, t, i, s, n, r) {
  var o, a, h, d, u = 0, c, f = /(\d+)|(\D+)/g, p = /\d/, g = r.alignEmptyValues, b = 0;
  if (!l && l !== 0)
    b = !e && e !== 0 ? 0 : -1;
  else if (!e && e !== 0)
    b = 1;
...
class G extends v {
  ...
  initializeColumn(e) {
    ...
    switch (typeof e.definition.sorter) {
      case "string":
        G.sorters[e.definition.sorter] ? t = G.sorters[e.definition.sorter] : console.warn("Sort Error - No such sorter found: ", e.definition.sorter);
        break;
      case "function":
...
Data:     `, e), !1;
  ...
  newSheet(e = {}) {
    var t;
    return e.rows || (e.rows = this.options("spreadsheetRows")), e.columns || (e.columns = this.options("spreadsheetColumns")), t = new me(this, e), this.sheets.push(t), this.element && this.element.appendChild(t.element), t;
  }
  removeSheet(e) {
  ...
  lookupSheet(e) {
    return e ? e instanceof me ? e : e instanceof ye ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
  }
  ///////////////////////////////////
  //////// Public Functions /////////
  ///////////////////////////////////
...
class Bi extends v {
  ...
  loadTooltip(e, t, i) {
    ...
    typeof i == "function" && (i = i(e, t.getComponent(), o)), i instanceof HTMLElement ? s = i : (s = document.createElement("div"), i === !0 && (t instanceof j ? i = t.value : t.definition.field ? this.langBind("columns|" + t.definition.field, (a) => {
...
class he extends v {
  ...
  _buildValidator(e, t) {
    var i = typeof e == "function" ? e : he.validators[e];
    return i ? {
...
var ie = /* @__PURE__ */ Object.freeze({
  ...
  FilterModule: P,
  FormatModule: V,
  FrozenColumnsModule: zt,
  FrozenRowsModule: Ht,
  GroupRowsModule: At,
  HistoryModule: J,
  HtmlTableImportModule: It,
  ImportModule: oe,
  InteractionModule: Xt,
  KeybindingsModule: W,
  MenuModule: qt,
  MoveColumnsModule: Yt,
  MoveRowsModule: q,
  MutatorModule: Y,
  PageModule: ae,
  PersistenceModule: H,
  ...
  ResizeRowsModule: hi,
  ResizeTableModule: di,
  ResponsiveLayoutModule: fi,
  SelectRangeModule: ki,
  SelectRowModule: gi,
  SortModule: G,
  SpreadsheetModule: _i,
  TooltipModule: Bi,
  ValidateModule: he
}), Ii = {
...
class ee extends k {
  ...
  scrollToRowPosition(e, t, i) {
    ...
    return new Promise((o, a) => {
      if (s > -1) {
        if (typeof i > "u" && (i = this.table.options.scrollToRowIfVisible), !i && E.elVisible(n) && (r = E.elOffset(n).top - E.elOffset(this.elementVertical).top, r > 0 && r < this.elementVertical.clientHeight - n.offsetHeight))
          return o(), !1;
...
class Gi extends k {
  constructor(e) {
    super(e), this.blockHozScrollEvent = !1, this.headersElement = null, this.contentsElement = null, this.rowHeader = null, this.element = null, this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.scrollLeft = 0, this.optionsList = new Re(this.table, "column definition", Ee), this.redrawBlock = !1, this.redrawBlockUpdate = null, this.renderer = null;
  }
  ////////////// Setup Functions /////////////////
  initialize() {
  ...
  setColumns(e, t) {
    ...
    this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.dispatch("columns-loading"), this.dispatchExternal("columnsLoading"), this.table.options.rowHeader && (this.rowHeader = new F(this.table.options.rowHeader === !0 ? {} : this.table.options.rowHeader, this, !0), this.columns.push(this.rowHeader), this.headersElement.appendChild(this.rowHeader.getElement()), this.rowHeader.columnRendered()), e.forEach((i, s) => {
      this._addColumn(i);
  ...
  _addColumn(e, t, i) {
    var s = new F(e, this), n = s.getElement(), r = i && this.findColumnIndex(i);
  ...
  //redraw columns
  redraw(e) {
    E.elVisible(this.element) && this.verticalAlignHeaders(), e && (this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()), this.confirm("table-redrawing", e) || this.layoutRefresh(e), this.dispatch("table-redraw", e), this.table.footerManager.redraw();
  }
}
class ji extends ee {
  constructor(e) {
  ...
  scrollToRowNearestTop(e) {
    var t = E.elOffset(e.getElement()).top;
  ...
  scrollToRow(e) {
    var t = e.getElement();
    this.elementVertical.scrollTop = E.elOffset(t).top - E.elOffset(this.elementVertical).top + this.elementVertical.scrollTop;
  }
  visibleRows(e) {
    return this.rows();
  }
...
class Ui extends ee {
  ...
  _virtualRenderFill(e, t, i) {
    var s = this.tableElement, n = this.elementVertical, r = 0, o = 0, a = 0, h = 0, d = 0, u = 0, c = this.rows(), f = c.length, p = 0, g, b, m = [], w = 0, R = 0, T = this.table.rowManager.fixedHeight, y = this.elementVertical.clientHeight, L = this.table.options.rowHeight, O = !0;
    if (e = e || 0, i = i || 0, !e)
      this.clear();
    else {
    ...
    if (f && E.elVisible(this.elementVertical)) {
      for (this.vDomTop = e, this.vDomBottom = e - 1, T || this.table.options.maxHeight ? (L && (R = y / L + this.vDomWindowBuffer / L), R = Math.max(this.vDomWindowMinTotalRows, Math.ceil(R))) : R = f; (R == f || o <= y + this.vDomWindowBuffer || w < this.vDomWindowMinTotalRows) && this.vDomBottom < f - 1; ) {
        for (m = [], b = document.createDocumentFragment(), u = 0; u < R && this.vDomBottom < f - 1; )
          p = this.vDomBottom + 1, g = c[p], this.styleRow(g, p), g.initialize(!1, !0), !g.heightInitialized && !this.table.options.rowHeight && g.clearCellHeight(), b.appendChild(g.getElement()), m.push(g), this.vDomBottom++, u++;
        if (!m.length)
          break;
        s.appendChild(b), m.forEach((S) => {
          S.rendered();
        });
        const A = [];
        m.forEach((S) => {
          S.heightInitialized || (S.calcHeight(!0), A.push(S));
        }), A.forEach((S) => {
          S.setCellHeight();
        }), m.forEach((S) => {
          a = S.getHeight(), w < r ? d += a : o += a, a > this.vDomWindowBuffer && (this.vDomWindowBuffer = a * 2), w++;
        }), O = this.table.rowManager.adjustTableSize(), y = this.elementVertical.clientHeight, O && (T || this.table.options.maxHeight) && (L = o / w, R = Math.max(this.vDomWindowMinTotalRows, Math.ceil(y / L + this.vDomWindowBuffer / L)));
      }
  ...
  _addBottomRow(e, t) {
    for (var i = this.tableElement, s = [], n = 0, r = this.vDomBottom + 1, o = 0, a = !0; a; ) {
      let h = e[r], d, u;
      h && o < this.vDomMaxRenderChain ? (d = h.getHeight() || this.vDomRowHeight, u = h.initialized, t >= d ? (this.styleRow(h, r), i.appendChild(h.getElement()), (!h.initialized || !h.heightInitialized) && s.push(h), h.initialize(), u || (d = h.getElement().offsetHeight, d > this.vDomWindowBuffer && (this.vDomWindowBuffer = d * 2)), t -= d, n += d, this.vDomBottom++, r++, o++) : a = !1) : a = !1;
    }
    for (let h of s)
      h.clearCellHeight();
...
Data:     `, e);
  ...
  addRowActual(e, t, i, s) {
    var n = e instanceof M ? e : new M(e || {}, this), r = this.findAddRowPos(t), o = -1, a, h;
  ...
  nextDisplayRow(e, t) {
    ...
    return i !== !1 && i < this.displayRowsCount - 1 && (s = this.getDisplayRows()[i + 1]), s && (!(s instanceof M) || s.type != "row") ? this.nextDisplayRow(s, t) : s;
  }
  prevDisplayRow(e, t) {
    var i = this.getDisplayRowIndex(e), s = !1;
    return i && (s = this.getDisplayRows()[i - 1]), t && s && (!(s instanceof M) || s.type != "row") ? this.prevDisplayRow(s, t) : s;
  }
  findRowIndex(e, t) {
    var i;
  ...
  refreshActiveData(e, t, i) {
    ...
    if (!this.table.destroyed) {
      ...
      if (this.redrawBlock) {
        ...
        E.elVisible(this.element) ? i ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, n, r, i)) : (this.refreshPipelines(e, n, r, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0)) : this.refreshPipelines(e, n, r, i), this.dispatch("data-refreshed");
    }
  }
    ...
    for (let a of i) {
      ...
      if (u && u.target === d)
        ...
        switch (a) {
          case "row":
          case "group":
            (s.components.includes("row") || s.components.includes("cell") || s.components.includes("group")) && (h = this.table.rowManager.getVisibleRows(!0).find((f) => f.getElement() === d), t.row && t.row.parentNode && t.row.parentNode.closest(".tabulator-row") && (t[a] = !1));
            break;
          case "column":
            s.components.includes("column") && (h = this.table.columnManager.findColumn(d));
            break;
          case "cell":
            s.components.includes("cell") && (n.row instanceof M ? h = n.row.findCell(d) : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"));
            break;
        }
      h && (n[a] = h, o[a] = {
        target: d,
...
function ss(l, e) {
  var t = this.table.rowManager.element.getBoundingClientRect().width, i = 0, s = 0, n = 0, r = 0, o = [], a = [], h = 0, d = 0, u = 0;
  function c(p) {
    var g;
    return typeof p == "string" ? p.indexOf("%") > -1 ? g = t / 100 * parseInt(p) : g = parseInt(p) : g = p, g;
  }
  function f(p, g, b, m) {
    var w = [], R = 0, T = 0, y = 0, L = n, O = 0, A = 0, S = [];
    function ue(C) {
      return b * (C.column.definition.widthGrow || 1);
    }
    function ce(C) {
      return c(C.width) - b * (C.column.definition.widthShrink || 0);
    }
    return p.forEach(function(C, hs) {
      var fe = m ? ce(C) : ue(C);
      C.column.minWidth >= fe ? w.push(C) : C.column.maxWidth && C.column.maxWidth < fe ? (C.width = C.column.maxWidth, g -= C.column.maxWidth, L -= m ? C.column.definition.widthShrink || 1 : C.column.definition.widthGrow || 1, L && (b = Math.floor(g / L))) : (S.push(C), A += m ? C.column.definition.widthShrink || 1 : C.column.definition.widthGrow || 1);
    }), w.length ? (w.forEach(function(C) {
      R += m ? C.width - C.column.minWidth : C.column.minWidth, C.width = C.column.minWidth;
    }), T = g - R, y = A ? Math.floor(T / A) : T, O = f(S, T, y, m)) : (O = A ? g - Math.floor(g / A) * A : g, S.forEach(function(C) {
      C.width = m ? ce(C) : ue(C);
    })), O;
  }
  this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(), this.table.rowManager.element.scrollHeight > this.table.rowManager.element.clientHeight && (t -= this.table.rowManager.element.offsetWidth - this.table.rowManager.element.clientWidth), l.forEach(function(p) {
    var g, b, m;
    p.visible && (g = p.definition.width, b = parseInt(p.minWidth), g ? (m = c(g), i += m > b ? m : b, p.definition.widthShrink && (a.push({
      column: p,
      width: m > b ? m : b
  ...
  }), s = t - i, r = Math.floor(s / n), u = f(o, s, r, !1), o.length && u > 0 && (o[o.length - 1].width += u), o.forEach(function(p) {
    s -= p.width;
  }), d = Math.abs(u) + s, d > 0 && h && (u = f(a, d, Math.floor(d / h), !0)), u && a.length && (a[a.length - 1].width -= u), o.forEach(function(p) {
...
class $ extends v {
  ...
  initialize() {
    ...
    $.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("tabulator-layout", this.mode), this.subscribe("column-init", this.initializeColumn.bind(this));
  }
  initializeColumn(e) {
  ...
  layout(e) {
    ...
    this.dispatch("layout-refreshing"), $.modes[this.mode].call(this, this.table.columnManager.columnsByIndex, e), t && this.table.rowManager.normalizeHeight(!0), this.dispatch("layout-refreshed");
  }
}
var rs = {
  default: {
...
class de extends v {
  ...
  initialize() {
    this.langList = E.deepClone(de.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
  ...
  setLocale(e) {
    ...
    this.locale = e, this.lang = E.deepClone(this.langList.default || {}), e != "default" && t(this.langList[e], this.lang), this.dispatchExternal("localized", this.locale, this.lang), this._executeBindings();
  }
  //get current locale
  getLocale(e) {
    return this.locale;
...
class D {
  static registry = {
    tables: [],
    register(e) {
      D.registry.tables.push(e);
    },
    deregister(e) {
      var t = D.registry.tables.indexOf(e);
      t > -1 && D.registry.tables.splice(t, 1);
    },
    lookupTable(e, t) {
      var i = [], s, n;
      if (typeof e == "string") {
        if (s = document.querySelectorAll(e), s.length)
          for (var r = 0; r < s.length; r++)
            n = D.registry.matchElement(s[r]), n && i.push(n);
      } else typeof HTMLElement < "u" && e instanceof HTMLElement || e instanceof D ? (n = D.registry.matchElement(e), n && i.push(n)) : Array.isArray(e) ? e.forEach(function(o) {
        i = i.concat(D.registry.lookupTable(o));
      }) : t || console.warn("Table Connection Error - Invalid Selector", e);
      return i;
    },
    matchElement(e) {
      return D.registry.tables.find(function(t) {
        return e instanceof D ? t === e : t.element === e;
      });
    }
  };
  static findTable(e) {
    var t = D.registry.lookupTable(e, !0);
...
class x extends D {
  ...
  static initializeModuleBinder(e) {
    x.modulesRegistered || (x.modulesRegistered = !0, x._registerModules(as, !0), e && x._registerModules(e));
  }
  static _extendModule(e, t, i) {
    if (x.moduleBindings[e]) {
      var s = x.moduleBindings[e][t];
      if (s)
        if (typeof i == "object")
          for (let n in i)
            s[n] = i[n];
  ...
  static _registerModule(e) {
    Array.isArray(e) || (e = [e]), e.forEach((t) => {
      x._registerModuleBinding(t), x._registerModuleExtensions(t);
    });
  }
  static _registerModuleBinding(e) {
    e.moduleName ? x.moduleBindings[e.moduleName] = e : console.error("Unable to bind module, no moduleName defined", e.moduleName);
  }
  static _registerModuleExtensions(e) {
    ...
    if (e.moduleExtensions)
      for (let i in t) {
        let s = t[i];
        if (x.moduleBindings[i])
          for (let n in s)
            x._extendModule(i, n, s[n]);
        else {
          x.moduleExtensions[i] || (x.moduleExtensions[i] = {});
          for (let n in s)
            x.moduleExtensions[i][n] || (x.moduleExtensions[i][n] = {}), Object.assign(x.moduleExtensions[i][n], s[n]);
        }
      }
    x._extendModuleFromQueue(e);
  }
  static _extendModuleFromQueue(e) {
    var t = x.moduleExtensions[e.moduleName];
    if (t)
      for (let i in t)
        x._extendModule(e.moduleName, i, t[i]);
  }
  //ensure that module are bound to instantiated function
  _bindModules() {
    var e = [], t = [], i = [];
    this.modules = {};
    for (var s in x.moduleBindings) {
      let n = x.moduleBindings[s], r = new n(this);
...
class z extends x {
  ...
  initializeCoreSystems(e) {
    this.columnManager = new Gi(this), this.rowManager = new Xi(this), this.footerManager = new Ki(this), this.dataLoader = new Yi(this), this.alertManager = new ls(this), this._bindModules(), this.options = this.optionsList.generate(z.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new $i(this, this.options, this.options.debugEventsExternal), this.eventBus = new Qi(this.options.debugEventsInternal), this.interactionMonitor = new Ji(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
  }
  ...
  destroy() {
    ...
    e.classList.remove("tabulator"), e.removeAttribute("tabulator-layout"), this.externalEvents.dispatch("tableDestroyed");
  }
  _detectBrowser() {
...
`), s = i[0] == "Error" ? i[2] : i[1], s[0] == " " ? e = s.trim().split(" ")[1].split(".")[1] : e = s.trim().split("@")[0]), console.warn("Table Not Initialized - Calling the " + e + " function before the table is initialized may result in inconsistent behavior, Please wait for the `tableBuilt` event before calling this function." + (t ? " " + t : ""))), this.initialized;
  ...
  setMaxHeight(e) {
    this.options.maxHeight = isNaN(e) ? e : e + "px", this.element.style.maxHeight = this.options.maxHeight, this.rowManager.initializeRenderer(), this.rowManager.redraw(!0);
  }
  setMinHeight(e) {
    this.options.minHeight = isNaN(e) ? e : e + "px", this.element.style.minHeight = this.options.minHeight, this.rowManager.initializeRenderer(), this.rowManager.redraw(!0);
  }
  //////////////////// Event Bus ///////////////////
  on(e, t) {
...
class us extends z {
  static extendModule() {
    z.initializeModuleBinder(ie), z._extendModule(...arguments);
  }
  static registerModule() {
    z.initializeModuleBinder(ie), z._registerModule(...arguments);
  }
  constructor(e, t, i) {
    super(e, t, ie);
  }
...
export {
  ...
  Pe as CalcComponent,
  we as CellComponent,
  X as ClipboardModule,
  B as ColumnCalcsModule,
  Ce as ColumnComponent,
  _e as DataTreeModule,
  K as DownloadModule,
  re as EditModule,
  N as ExportModule,
  P as FilterModule,
  V as FormatModule,
  zt as FrozenColumnsModule,
  Ht as FrozenRowsModule,
  Ft as GroupComponent,
  At as GroupRowsModule,
  J as HistoryModule,
  It as HtmlTableImportModule,
  oe as ImportModule,
  Xt as InteractionModule,
  W as KeybindingsModule,
  qt as MenuModule,
  v as Module,
  Yt as MoveColumnsModule,
  q as MoveRowsModule,
  Y as MutatorModule,
  ae as PageModule,
  H as PersistenceModule,
  ri as PopupModule,
  oi as PrintModule,
  cs as PseudoRow,
  bi as RangeComponent,
  ai as ReactiveDataModule,
  ee as Renderer,
  li as ResizeColumnsModule,
  hi as ResizeRowsModule,
  di as ResizeTableModule,
  fi as ResponsiveLayoutModule,
  Q as RowComponent,
  ki as SelectRangeModule,
  gi as SelectRowModule,
  ye as SheetComponent,
  G as SortModule,
  _i as SpreadsheetModule,
  z as Tabulator,
  us as TabulatorFull,
  Bi as TooltipModule,
  he as ValidateModule
};
//# sourceMappingURL=tabulator_esm-CubK_WT2.js.map
